...
const snippet = `hermes config set webhooks.relay_url https://clawproxy.io/api/ingress/hermes
hermes config set webhooks.node_token cpn_your_node_token
